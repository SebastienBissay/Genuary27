...
public final class Parameters {
    public static final int SEED = 20250126;
    public static final int WIDTH = 2025;
    public static final int HEIGHT = 2025;
    public static final int MARGIN = 100;
    public static final int MAX_DEPTH = 5;
    public static final float SUBDIVISION_WEIGHT = .75f;

    public static final Color BACKGROUND_COLOR = new Color("FAF7F0");
    public static final Color STROKE_COLOR = new Color("4A4947");
